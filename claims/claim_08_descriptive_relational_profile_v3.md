...
```text
T = NONE_CLAIMED                  -> Philosophy of ML / predictive ML
T = INFERRED_BY_C                 -> Equation Discovery / automated discovery
layered simulator/surrogate C     -> SciML / surrogate / V&V
hybrid theory + learned C         -> Physics-informed ML / SciML
```
...
Nur die gemeinsame Komposition bleibt als Kandidat:

```text
classical model-credibility genealogy
+
dynamic role occupation of T and C in AI for Science
+
claim-relative RT / TC / CR evidence profiling
+
REAL / SYNTHETIC / HYBRID referent typing
+
descriptive comparison of kinds of scientific success
```

Im v0.1-Audit wurde kein einzelner Direktanalog gefunden, der diese Elemente in genau dieser gemeinsamen Semantik verbindet. Dies ist ein Search Result, kein Originalitätsbeweis.

## Non-Claims

C08-D-R3 behauptet nicht:

- neue R/T/C-Dreieckstopologie;
- neue Verification-/Validation-Trennung;
- Neuheit von intended use oder scope;
- Neuheit von Prediction ohne Theorie;
- Neuheit von Equation Discovery oder AI-generated theory;
- Neuheit von Surrogate-/synthetic-data credibility;
- Neuheit von Physics-informed ML;
- Neuheit pluraler epistemischer Ziele wie Prediction/Explanation/Discovery/Understanding;
- praktische Überlegenheit gegenüber V&V, SciML-Credibility, P.E.D.U.D. oder anderen Frameworks;
- dass ein einziges Dreiecksprofil die vollständige Semantik wissenschaftlicher Modelle erfasst.
