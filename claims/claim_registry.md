...
| AFS-DMO | Minimaler ML/AI-for-Science-Provenance-Demonstrator | PENDING REVIEW | soll verbleibende Integrationshypothese mit einer lernbasierten Übergangsebene testen | — |
...
Der nächste Test führt genau eine daten-/lernbasierte Übersetzung ein. Noch wird kein neuer ML-Claim akzeptiert.

## Abhängigkeitslogik

C01 → C02 → C03 → C04 → D005 → D006 → D007 → Full v0.1 run → C05/D008 → C06-R/D009 → AFS-DMO review → Implementation Contract → ML run → erneuter Originalitätstest.
